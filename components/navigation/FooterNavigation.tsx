...
import { footerNavItems } from "../../data/navigationConfig";
 ...
 */
export default function FooterNavigation({ activeTab, onChange }: FooterNavigationProps) {
  const insets = useSafeAreaInsets();

  const renderFooterIcon = (item: NavItem, color: string): React.ReactNode => {
